  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/dipam.ghosh.18/"
            ...
            <li>
              <a
                href="https://www.instagram.com/dipam_581/?hl=en"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">&copy; {currentYear} Dipam Ghosh. All rights reserved.</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
